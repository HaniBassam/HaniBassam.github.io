      ...
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          <p className="hero--section-description">
            Hi, I’m Hani, a passionate front-end developer and
            multimediedesigner with a flair for creating engaging and
            user-friendly digital experiences. With a solid foundation in HTML,
            CSS, JavaScript, and React, I enjoy turning complex problems into
            simple, beautiful solutions. My background in graphic design and
            content creation allows me to bring a creative touch to every
            project I work on. I thrive on learning and pushing my skills to the
            next level, whether it’s through coding, exploring new design
            trends, or collaborating with others to create something meaningful.
            I’m detail-oriented, adaptable, and driven by the desire to make a
            positive impact through technology and design. When I’m not coding,
            you’ll often find me brainstorming new ideas or finding inspiration
